...
function About() {
  return (
    <div className="flex flex-col relative xl:flex-row font-league-gothic font-bold mx-4 mt-80 p-5 rounded-tl-2xl rounded-tr-2xl bg-orangePrimary bg-gradient-45 ">
      <div className="flex flex-col xl:w-1/2">
        <h2 className="text-[70px] mt-20 md:max-w-[430px] self-center text-center tracking-[2px] ">
          Get to know our product better
        </h2>
        <p className="m-2 mt-12 text-[25px] font-Montserrat text-stone-900 tracking-[2px] opacity-90">
      ...
      <div className="flex flex-col lg:mb-1 items-center xl:gap-20 xl:w-1/2">
        ...
        <img className="mt-8 w-3/4 xl:w-full  rounded-lg " src={WinMac} alt="Windows-Android Switch" />
      </div>
