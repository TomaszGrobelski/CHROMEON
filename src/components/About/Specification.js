  ...
  return (
    <div className="flex justify-center font-league-gothic font-bold pt-40 mx-4 p-5 bg-orangePrimary bg-gradient-135 rounded-br-2xl rounded-bl-2xl">
      <div className="flex flex-col items-center">
        ...
        <p className="m-4 mt-12 text-[30px] max-w-[700px] text-center text-gray-800 tracking-[2px] opacity-75">The latest Bluetooth technology provides a more stable connection, saving energy and reducing latency. All new Keychron keyboards use Bluetooth 5.1 to ensure stable and smooth everyday use.</p>
